...
@Module
@InstallIn(ServiceComponent::class)//we used ServiceComponent here cuz this will o0nly exist until service is running
object ServiceModule {
    //we require a fused client to make  request to google for location updates
    @ServiceScoped//we use this annotation cuz we want to create a single instance of this dependency in the lifecycle of the Service
    @Provides
